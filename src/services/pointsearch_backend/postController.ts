...
/** deletePosts POST /api/post/list/delete */
export async function deletePostsUsingPOST(
  body: API.DeleteRequest[],
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseBoolean_>('/api/post/list/delete', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** searchUsersByTags GET /api/post/search/tags */
export async function searchUsersByTagsUsingGET(
  body: API.TagsRequest,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponsePagePostVO_>('/api/post/search/tags', {
    method: 'GET',
    headers: {
      'Content-Type': 'application/json',
    },
