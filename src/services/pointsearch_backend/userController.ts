...
/** changeASKey POST /api/user/change/ask */
export async function changeASKeyUsingPOST(options?: { [key: string]: any }) {
  return request<API.BaseResponseASKVO_>('/api/user/change/ask', {
    method: 'POST',
    ...(options || {}),
  });
}
...
/** deleteUsers POST /api/user/list/delete */
export async function deleteUsersUsingPOST(
  body: API.DeleteRequest[],
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseBoolean_>('/api/user/list/delete', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
